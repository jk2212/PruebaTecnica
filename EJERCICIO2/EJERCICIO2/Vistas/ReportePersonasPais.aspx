<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportePersonasPais.aspx.cs"%> 
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br />
      ...
      <table style="width: 100%">
        <tr>
            <td style="font-size: x-large; text-align: center;" class="auto-style1">Reporte Personas por Pais</td>
            <td>
                <img alt="" class="auto-style2" src="../Imagenes/86.png" /></td>
        </tr>
        <tr>
...
ORDER BY Paises.Pais"></asp:SqlDataSource>
                </td>
            </tr>
